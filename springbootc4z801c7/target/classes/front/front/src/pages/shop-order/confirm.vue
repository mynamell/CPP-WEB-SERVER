<template>
  <div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <div class="section-title" :style='{"margin":"0px 0 20px","color":"#333","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230921/eb4b56c7d55142c4b9339e032022bfb5.png) repeat-x center bottom","width":"100%","fontSize":"24px","lineHeight":"56px","height":"66px"}'>确认{{totalPrice>0?'下单':'预订'}}</div>
                ...
                this.$http.get(`${item.tablename}/info/${item.goodid}`).then(res => {
                    ...
                    this.$http.post(`${item.tablename}/update`, data).then(res => {
                        ...
                        let order = {
                            ...
                            xiaoshouzhanghao: item.xiaoshouzhanghao,
