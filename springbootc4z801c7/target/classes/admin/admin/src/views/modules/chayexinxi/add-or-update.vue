	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="茶叶分类" prop="chayefenlei">
					<el-input  v-model="ruleForm.chayefenlei" placeholder="茶叶分类" clearable  :readonly="ro.chayefenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="茶叶分类" prop="chayefenlei">
					<el-input v-model="ruleForm.chayefenlei" placeholder="茶叶分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="产地" prop="chandi">
					<el-input  v-model="ruleForm.chandi" placeholder="产地" clearable  :readonly="ro.chandi"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="产地" prop="chandi">
...
export default {
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.xiaoshouzhanghao!=''&&json.xiaoshouzhanghao) || json.xiaoshouzhanghao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.xiaoshouzhanghao = json.xiaoshouzhanghao
						this.ro.xiaoshouzhanghao = true;
					}
					if(((json.xiaoshouxingming!=''&&json.xiaoshouxingming) || json.xiaoshouxingming==0) && this.$storage.get("role")!="管理员"){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../springbootc4z801c7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
