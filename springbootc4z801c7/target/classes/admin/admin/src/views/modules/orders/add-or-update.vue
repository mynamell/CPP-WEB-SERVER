	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="商户名称" prop="xiaoshouzhanghao">
					<el-input  v-model="ruleForm.xiaoshouzhanghao" placeholder="商户名称" clearable  :readonly="ro.xiaoshouzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="商户名称" prop="xiaoshouzhanghao">
					<el-input v-model="ruleForm.xiaoshouzhanghao" placeholder="商户名称" readonly></el-input>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springbootc4z801c7/upload');
        } else {
