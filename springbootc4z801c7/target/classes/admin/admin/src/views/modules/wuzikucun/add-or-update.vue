	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-else-if="ruleForm.wuzibianhao" label="物资编号" prop="wuzibianhao">
					<el-input v-model="ruleForm.wuzibianhao" placeholder="物资编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="物资分类" prop="wuzifenlei">
					<el-input  v-model="ruleForm.wuzifenlei" placeholder="物资分类" clearable  :readonly="ro.wuzifenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="物资分类" prop="wuzifenlei">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="type!='info'"  label="物资详情" prop="wuzixiangqing">
					<editor 
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.wuzixiangqing" label="物资详情" prop="wuzixiangqing">
                    <span :style='{"fontSize":"inherit","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.wuzixiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.wuzixiangqing = this.ruleForm.wuzixiangqing.replace(reg,'../../../springbootc4z801c7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
