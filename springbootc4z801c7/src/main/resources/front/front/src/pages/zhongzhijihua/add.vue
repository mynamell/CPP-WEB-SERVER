...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="种植数量" prop="zhongzhishuliang">
            <el-input  v-model.number="ruleForm.zhongzhishuliang" 
                placeholder="种植数量" clearable :readonly=" false  ||ro.zhongzhishuliang"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="种植位置" prop="zhongzhiweizhi">
            <el-input  v-model="ruleForm.zhongzhiweizhi" 
                placeholder="种植位置" clearable :readonly=" false  ||ro.zhongzhiweizhi"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="种植状态" prop="zhongzhizhuangtai">
            <el-select v-model="ruleForm.zhongzhizhuangtai" placeholder="请选择种植状态"  >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="主管账号" prop="zhuguanzhanghao">
            <el-select  @change="zhuguanzhanghaoChange" v-model="ruleForm.zhuguanzhanghao" placeholder="请选择主管账号">
              <el-option
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/chayuanzhuguan/zhuguanzhanghao', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.zhuguanzhanghaoOptions = res.data.data;
          }
        });
      },
      // 下二随
      zhuguanzhanghaoChange () {
        this.$http.get('follow/chayuanzhuguan/zhuguanzhanghao?columnValue=' + this.ruleForm.zhuguanzhanghao, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            if(res.data.data.zhuguanxingming){
              this.ruleForm.zhuguanxingming = res.data.data.zhuguanxingming
            }
          }
        });
      },
