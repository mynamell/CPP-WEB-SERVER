<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"16px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="销售账号" prop="xiaoshouzhanghao">
					<el-input  v-model="ruleForm.xiaoshouzhanghao" placeholder="销售账号" clearable  :readonly="ro.xiaoshouzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="销售账号" prop="xiaoshouzhanghao">
					<el-input v-model="ruleForm.xiaoshouzhanghao" placeholder="销售账号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="销售姓名" prop="xiaoshouxingming">
					<el-input  v-model="ruleForm.xiaoshouxingming" placeholder="销售姓名" clearable  :readonly="ro.xiaoshouxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="销售姓名" prop="xiaoshouxingming">
